    ...
    USER_INFO.innerHTML = `
        <div class="user-info">
            <div class="user-avatar">
                ...
                <p class="bio">${USER.bio === null ? "No bio" : USER.bio}</p>
            </div>
        ...
        ${USER.repos.map(repo => 
            `<div class="repo">
                ...
                <p class="repo-description">${repo.description === null ? "No description" : repo.description}</p>
                ...
                <a href="${repo.html_url}" target="_blank"><span>🔗${repo.html_url}</span></a>
            </div>` 
        ).join('')}
    `
}